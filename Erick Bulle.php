...
<div>
  <img src="img/ErickBulle/Buell-Logo.png" alt="BMW" srcset="" align="center" style="height: 80px;float: right;mix-blend-mode: color-burn;">
  </div>
...
<div style="display: flex;justify-content: center;align-items: center;">
      <div class="cards">
        <div class="geeks">
          <img src="/img/ErickBulle/1e9d5f_8d2e70d241a9491db1b423065f8b7d7a_mv2-removebg-preview.png" style="height: 260px;">
        </div>
        <div class="title">
          <h2 style="color: aliceblue;">HAMMERHEAD 1190<br> Reveal your racing attitude.</h2>

        </div>
</div>
<div class="cards">
  <div class="geeks">
    <img src="/img/ErickBulle/833e92_9d9df896129c4b0d98da0af62eb8f9b2~mv2-fotor-bg-remover-20230804221658.png" style="height: 260px;">
  </div>
  <div class="title">
    <h2 style="color: aliceblue;">BUELL
      SUPER CRUISER <br> The superbike of superlatives.</h2>

  </div>
</div><div class="cards">
  <div class="geeks">
    <img src="/img/ErickBulle/2023-buell-supertouring-first-look-4-fotor-bg-remover-20230804222021.png" style="height: 260px;">
  </div>
  <div class="title">
    <h2 style="color: aliceblue;">BUELL SUPERTOURING <br>  The superbike of superlatives.</h2>
  ...
  <div class="cards">
    <div class="geeks">
      <img src="/img/ErickBulle/1e9d5f_95864ac1b1914182abe6a1aad32b34ef_mv2-removebg-preview.png" style="height: 260px;">
    </div>
    <div class="title">
      <h2 style="color: aliceblue;">BUELL 1190SX <br> Challenge your city.</h2>
  
    </div>
  </div>
  <div class="cards">
    <div class="geeks">
      <img src="/img/ErickBulle/1e9d5f_33452336b22b41f090ee2990f2f1e22c_mv2-removebg-preview.png" style="height: 260px;">
    </div>
    <div class="title">
      <h2 style="color: aliceblue;">BUELL
        BAJA DUNE RACER <br> Challenge your city.</h2>
...
<div align="center">
  <b><p style="font-size: 40px;color: rgb(0, 0, 0);">Some of Our Custom Styles</p></b>
     ...
     <div class="card3" data-aos="fade-up"  data-aos-duration="1500">
      ...
      <button id="redM" onclick="redM()"></button>
