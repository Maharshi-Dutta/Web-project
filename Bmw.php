...
<div>
  <img src="img/bmw_motorrad_logo.svg.asset.1585209612412.svg" alt="BMW" srcset="" align="center" style="height: 80px;float: right;">
  </div>
...
<div style="margin-left:20px;position: relative;">
      <div class="cards">
        <div class="geeks">
          <img src="/project/img/BMW/bmw 310rr.png" style="height: 260px;">
        </div>
        <div class="title">
          <h2 style="color: aliceblue;">BMW 310RR<br> Reveal your racing attitude.</h2>

        </div>
</div>
<div class="cards">
  <div class="geeks">
    <img src="/project/img/BMW/M1000rr.png" style="height: 260px;">
  </div>
  <div class="title">
    <h2 style="color: aliceblue;">BMW M1000RR <br> The superbike of superlatives.</h2>

  </div>
</div><div class="cards">
  <div class="geeks">
    <img src="/project/img/bmw-removebg-preview.png" style="height: 260px;">
  </div>
  <div class="title">
    <h2 style="color: aliceblue;">BMW S1000RR <br>  The superbike of superlatives.</h2>
  ...
  <div style="margin-left:20px;position: relative;">
        <div class="cards">
          <div class="geeks">
            <img src="/img/BMW/download-removebg-preview.png" style="height: 260px;">
          </div>
          <div class="title">
            <h2 style="color: aliceblue;">BMW S1000R<br> Awaken the Daredevil.</h2>
  
          </div>
  </div>
  <div class="cards">
    <div class="geeks">
      <img src="/img/BMW/BMW S310R.png" style="height: 260px;">
    </div>
    <div class="title">
      <h2 style="color: aliceblue;">BMW 310R <br> Challenge your city.</h2>
  
    </div>
  </div>
  <div class="cards">
    <div class="geeks">
      <img src="/img/BMW/silver-removebg-preview.png" style="height: 260px;">
    </div>
    <div class="title">
      <h2 style="color: aliceblue;">BMW M1000R <br> Challenge your city.</h2>
...
<div align="center">
  <b><p style="font-size: 40px;color: rgb(0, 0, 0);">Some of Our Custom Styles</p></b>
    ...
    <p style="color: aquamarine;">Disclamer</p>
<P style="color: aquamarine;">For Any Purchase Or Further Details Refer To the Contact Page</P>
