...
<script src="js/harley.js"></script>
...
<div>
  <img src="img/Harley/1200px-Harley-Davidson_logo.svg.png" alt="BMW" srcset="" align="center" style="height: 80px;float: right;">
  </div>
...
<div style="display: flex;justify-content: center;align-items: center;">
      <div class="cards">
        <div class="geeks">
          <img src="/img/Harley/2023-heritage-classic-114-motorcycle-nav.webp" style="height: 260px;">
        </div>
        <div class="title">
          <h2 style="color: aliceblue;">Heritage Classic<br> Reveal your racing attitude.</h2>

        </div>
</div>
<div class="cards">
  <div class="geeks">
    <img src="/img/Harley/fatblack.webp" style="height: 260px;">
  </div>
  <div class="title">
    <h2 style="color: aliceblue;"> Fat Bob 114 <br> The superbike of superlatives.</h2>

  </div>
</div><div class="cards">
  <div class="geeks">
    <img src="/img/Harley/2023-sportster-s-motorcycle-nav.webp" style="height: 260px;">
  </div>
  <div class="title">
    <h2 style="color: aliceblue;">Sportster <br>  The superbike of superlatives.</h2>
  ...
  <div class="cards">
    <div class="geeks">
      <img src="/img/Harley/2023-pan-america-1250-special-motorcycle-nav.webp" style="height: 260px;">
    </div>
    <div class="title">
      <h2 style="color: aliceblue;">Pan America 1250 Special <br> Challenge your city.</h2>
  
    </div>
  </div>
  <div class="cards">
    <div class="geeks">
      <img src="/img/Harley/2023-nightster-motorcycle-nav.webp" style="height: 260px;">
    </div>
    <div class="title">
      <h2 style="color: aliceblue;"> Nightster <br> Challenge your city.</h2>
  
    </div>
  </div>
  <div class="cards">
    <div class="geeks">
      <img src="/img/Harley/2023-street-glide-special-motorcycle-nav.webp" style="height: 260px;">
    </div>
    <div class="title">
      <h2 style="color: aliceblue;"> Road Glide <br> Challenge your city.</h2>
...
<div align="center">
  <b><p style="font-size: 40px;color: rgb(0, 0, 0);">Some of Our Custom Styles</p></b>
     <div class="card" data-aos="fade-up"  data-aos-duration="1500">
      <p>Fat Bob 114</p>
      <button id="red" onclick="redRR()"></button>
      <button id="green" onclick="greenRR()"></button>
      <button id="blue" onclick="blueRR()"></button>
     
      <div class="bikeimgr" id="bike1">
      </div>
     </div>
     <div class="card2" data-aos="fade-up"  data-aos-duration="1500">
      
      <p> Nightster™ Special</p>
      <button id="redR" onclick="redR()"></button>
      <button id="whiteR" onclick="whiteR()"></button>
